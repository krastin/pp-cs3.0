import time
from find_two_smallest import find_two_smallest_edit, find_two_smallest_copy, find_two_smallest_walk
...
if __name__ == '__main__':
    ...
    find_remove_find_time = time_find_two_smallest(find_two_smallest_edit, sea_levels)
    sort_get_minimums_time = time_find_two_smallest(find_two_smallest_copy, sea_levels)
    walk_through_time = time_find_two_smallest(find_two_smallest_walk, sea_levels)
